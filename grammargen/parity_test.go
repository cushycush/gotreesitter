...
func init() {
	...
	batch4 := []grammarSpec{
		...
		{name: "agda", blobFunc: grammars.AgdaLanguage, timeout: 60 * time.Second},
		{name: "angular", blobFunc: grammars.AngularLanguage, timeout: 60 * time.Second},
		{name: "arduino", blobFunc: grammars.ArduinoLanguage, timeout: 60 * time.Second},
		{name: "astro", blobFunc: grammars.AstroLanguage, timeout: 60 * time.Second},
		{name: "awk", blobFunc: grammars.AwkLanguage},
		{name: "beancount", blobFunc: grammars.BeancountLanguage},
		{name: "bicep", blobFunc: grammars.BicepLanguage, timeout: 60 * time.Second},
		{name: "bitbake", blobFunc: grammars.BitbakeLanguage},
		{name: "blade", blobFunc: grammars.BladeLanguage, timeout: 60 * time.Second},
		{name: "cairo", blobFunc: grammars.CairoLanguage, timeout: 60 * time.Second},
		{name: "cooklang", blobFunc: grammars.CooklangLanguage},
		{name: "cuda", blobFunc: grammars.CudaLanguage, timeout: 60 * time.Second},
		{name: "cue", blobFunc: grammars.CueLanguage},
		{name: "disassembly", blobFunc: grammars.DisassemblyLanguage},
		{name: "djot", blobFunc: grammars.DjotLanguage},
		{name: "doxygen", blobFunc: grammars.DoxygenLanguage},
		{name: "dtd", blobFunc: grammars.DtdLanguage,
			jsonPath: "/tmp/grammar_parity/xml/dtd/src/grammar.json"},
		{name: "earthfile", blobFunc: grammars.EarthfileLanguage},
		{name: "editorconfig", blobFunc: grammars.EditorconfigLanguage},
		{name: "firrtl", blobFunc: grammars.FirrtlLanguage},
		{name: "foam", blobFunc: grammars.FoamLanguage},
		{name: "fortran", blobFunc: grammars.FortranLanguage, timeout: 90 * time.Second},
		{name: "fsharp", blobFunc: grammars.FsharpLanguage, timeout: 90 * time.Second,
			jsonPath: "/tmp/grammar_parity/fsharp/fsharp/src/grammar.json"},
		{name: "gdscript", blobFunc: grammars.GdscriptLanguage, timeout: 60 * time.Second},
		{name: "gn", blobFunc: grammars.GnLanguage},
		{name: "godot_resource", blobFunc: grammars.GodotResourceLanguage},
		{name: "hack", blobFunc: grammars.HackLanguage, timeout: 90 * time.Second},
		{name: "haxe", blobFunc: grammars.HaxeLanguage, timeout: 60 * time.Second},
		{name: "hlsl", blobFunc: grammars.HlslLanguage, timeout: 60 * time.Second},
		{name: "janet", blobFunc: grammars.JanetLanguage},
		{name: "just", blobFunc: grammars.JustLanguage},
		{name: "kconfig", blobFunc: grammars.KconfigLanguage},
		{name: "kdl", blobFunc: grammars.KdlLanguage},
		{name: "less", blobFunc: grammars.LessLanguage},
		{name: "liquid", blobFunc: grammars.LiquidLanguage},
		{name: "luau", blobFunc: grammars.LuauLanguage, timeout: 60 * time.Second},
		{name: "markdown_inline", blobFunc: grammars.MarkdownInlineLanguage, timeout: 60 * time.Second,
			jsonPath: "/tmp/grammar_parity/markdown/tree-sitter-markdown-inline/src/grammar.json"},
		{name: "matlab", blobFunc: grammars.MatlabLanguage, timeout: 60 * time.Second},
		{name: "mojo", blobFunc: grammars.MojoLanguage, timeout: 60 * time.Second},
		{name: "nginx", blobFunc: grammars.NginxLanguage},
		{name: "norg", blobFunc: grammars.NorgLanguage, timeout: 60 * time.Second},
		{name: "nushell", blobFunc: grammars.NushellLanguage},
		{name: "odin", blobFunc: grammars.OdinLanguage, timeout: 60 * time.Second},
		{name: "org", blobFunc: grammars.OrgLanguage},
		{name: "pkl", blobFunc: grammars.PklLanguage},
		{name: "pug", blobFunc: grammars.PugLanguage},
		{name: "purescript", blobFunc: grammars.PurescriptLanguage, timeout: 60 * time.Second},
		{name: "r", blobFunc: grammars.RLanguage, timeout: 60 * time.Second},
		{name: "rescript", blobFunc: grammars.RescriptLanguage, timeout: 60 * time.Second},
		{name: "rst", blobFunc: grammars.RstLanguage},
		{name: "squirrel", blobFunc: grammars.SquirrelLanguage},
		{name: "svelte", blobFunc: grammars.SvelteLanguage, timeout: 60 * time.Second},
		{name: "tablegen", blobFunc: grammars.TablegenLanguage},
		{name: "tcl", blobFunc: grammars.TclLanguage},
		{name: "templ", blobFunc: grammars.TemplLanguage},
		{name: "tlaplus", blobFunc: grammars.TlaplusLanguage, timeout: 60 * time.Second},
		{name: "typst", blobFunc: grammars.TypstLanguage},
		{name: "uxntal", blobFunc: grammars.UxntalLanguage},
		{name: "vhdl", blobFunc: grammars.VhdlLanguage, timeout: 60 * time.Second},
		{name: "vue", blobFunc: grammars.VueLanguage, timeout: 60 * time.Second},
		{name: "wgsl", blobFunc: grammars.WgslLanguage},
		{name: "wolfram", blobFunc: grammars.WolframLanguage, timeout: 60 * time.Second},
		{name: "yuck", blobFunc: grammars.YuckLanguage},
	}
