...
func init() {
	...
	batch4 := []grammarSpec{
		...
		{name: "javascript", blobFunc: grammars.JavascriptLanguage, timeout: 90 * time.Second, expectNoErrors: 1},
		...
		{name: "php", blobFunc: grammars.PhpLanguage, timeout: 90 * time.Second, expectNoErrors: 1,
		...
		{name: "ocaml", blobFunc: grammars.OcamlLanguage, timeout: 90 * time.Second, expectNoErrors: 1,
