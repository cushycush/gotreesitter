...
func init() {
	...
	batch4 := []grammarSpec{
		...
		{name: "prisma", blobFunc: grammars.PrismaLanguage, expectGenerate: boolPtr(false)},
		...
		{name: "awk", blobFunc: grammars.AwkLanguage, expectGenerate: boolPtr(false)},
		...
		{name: "hack", blobFunc: grammars.HackLanguage, timeout: 90 * time.Second, expectGenerate: boolPtr(false)},
		...
		{name: "kdl", blobFunc: grammars.KdlLanguage, expectImport: boolPtr(false)},
		...
		{name: "norg", blobFunc: grammars.NorgLanguage, timeout: 60 * time.Second, expectGenerate: boolPtr(false)},
		{name: "nushell", blobFunc: grammars.NushellLanguage, expectGenerate: boolPtr(false)},
